...
getwd()
setwd('Desktop/Education/Data Science/Big Mart Sales Prediction')
...
######Linear Regression########
linear_regression_model = lm(Item_Outlet_Sales ~ . , data = train[,-c("Item_Identifier")])

#predicting on test dataset using Linear Regression
Item_Outlet_Sales_Linear_Regression = predict(linear_regression_model, test[,-c("Item_Identifier")])
...
plot(varImp(randomforest_regression_model))  
...
Predictions  = cbind(test1,Item_Outlet_Sales_Linear_Regression,Item_Outlet_Sales_Lasso_Linear_Regression,Item_Outlet_Sales_Ridge_Linear_Regression,
